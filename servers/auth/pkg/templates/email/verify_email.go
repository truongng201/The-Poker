...
func GenerateVerifyEmailTemplate(data VerifyEmailTemplateData) string {
	VerifyEmailTemplate = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head>
...
<body dir="ltr" style="height:100%;margin:0;line-height:1.4;background-color:#F2F4F6;color:#74787E;-webkit-text-size-adjust:none;width:100%">
  <table class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" style="width:100%;margin:0;padding:0;background-color:#F2F4F6">
                ...
                <tbody><tr>
                  <td class="content-cell" style="color:#74787E;font-size:15px;line-height:18px;padding:35px">
                    <h1 style="margin-top:0;color:#2F3133;font-size:19px;font-weight:bold">Dear {{.Username}},</h1>
                            ...
                            <p style="margin-top:0;color:#74787E;font-size:16px;line-height:1.5em">Welcome to The Poker! We&#39;re very excited to have you on board.</p>
                              ...
                              <!--[if mso]>
                                ...
                                <div style="margin: 30px auto;v-text-anchor:middle;text-align:center">
                                  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" 
                                    ...
                                    href="{{.VerifyLink}}" 
                                    style="height:45px;v-text-anchor:middle;width:200px;background-color:#22BC66;"
                                    arcsize="10%" 
                                    strokecolor="#22BC66" fillcolor="#22BC66"
                                    >
                                    <w:anchorlock/>
                                ...
                                <tbody><tr>
                                  <td align="center" style="padding:10px 5px;color:#74787E;font-size:15px;line-height:18px">
                                    <div>
                                        ...
                                        <a href="{{.VerifyLink}}" class="button" style="display:inline-block;border-radius:3px;font-size:15px;line-height:45px;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;mso-hide:all;color:#ffffff;background-color:#22BC66;width:200px" target="_blank" width="200">
                                          Verify your account
                                        </a>
	...
	tmpl, err := template.New("VerifyEmailTemplate").Parse(VerifyEmailTemplate)
	if err != nil {
		panic(err)
	}
	buf := &bytes.Buffer{}
